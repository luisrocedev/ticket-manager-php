...
- Mensajes de error claros y controlados en la interfaz.
...
- Separación de lógica en controladores, modelos, vistas y servicios (MVC).

---

## 6. Clases y objetos principales

- Clases: Ticket, Producto, Usuario, Factura.
...
- Generación de tickets y facturas en PDF con dompdf.
- Gestión de sesiones y autenticación de usuarios.
- Modularidad y reutilización de funciones.
- Control de stock automático al finalizar ticket.
...
- Informes de ventas y estadísticas (productos más vendidos, ticket promedio, etc.).

---

## 9. Estructuras de datos utilizadas

- Arrays y objetos para productos, tickets, usuarios y facturas.
...
- Búsqueda avanzada de productos y clientes (por nombre, código, DNI/CIF).
...
- Refuerzo de la seguridad en validaciones y roles.
...
- Tablas: productos, tickets, usuarios, facturas.
...
- Filtros por fecha, cliente, método de pago, etc.
...
- Actualización en tiempo real de totales y productos.
...
- Facilitar la gestión y generación de tickets de compra y facturas.

---

## 2. Necesidad o problema que soluciona

- Permite administrar productos, usuarios, tickets y facturas de forma eficiente.
...
- Módulo de productos, tickets, usuarios, facturas, informes y utilidades.
